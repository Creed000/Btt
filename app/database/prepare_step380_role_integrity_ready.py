...
from app.database.master_core_integrity_upgrade import (
    upgrade_master_core_integrity,
)
from app.database.salon_core_integrity_upgrade import (
    upgrade_salon_core_integrity,
)
from app.database.branch_core_integrity_upgrade import (
    upgrade_branch_core_integrity,
)
from app.database.client_core_integrity_upgrade import (
    upgrade_client_core_integrity,
)
from app.database.user_core_integrity_upgrade import (
    upgrade_user_core_integrity,
)
from app.database.city_core_integrity_upgrade import (
    upgrade_city_core_integrity,
)
from app.database.booking_reminder_integrity_upgrade import (
    upgrade_booking_reminder_integrity,
)
from app.database.role_core_integrity_upgrade import (
    upgrade_role_core_integrity,
)
...
def prepare_database() -> None:
    ...
    # 27. Core integrity таблицы Master.
    upgrade_master_core_integrity()


    # 28. Core integrity таблицы Salon.
    upgrade_salon_core_integrity()


    # 29. Core integrity таблицы Branch.
    upgrade_branch_core_integrity()


    # 30. Core integrity таблицы Client.
    upgrade_client_core_integrity()


    # 31. Core integrity таблицы User.
    upgrade_user_core_integrity()


    # 32. Core integrity таблицы City.
    upgrade_city_core_integrity()


    # 33. Integrity reminder-state внутри Booking.
    upgrade_booking_reminder_integrity()


    # 34. Синхронизация справочника Role с User.role.
    upgrade_role_core_integrity()

    # 35. Уникальные активные слоты мастера и клиента.
    upgrade_booking_active_slot_uniqueness()


    # 36. DB-защита от пересекающихся активных интервалов.
    upgrade_booking_overlap_exclusion()
