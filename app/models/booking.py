...
class Booking(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "NOT reminder_24h_client_sent "
            "OR reminder_24h_client_claimed_at IS NULL",
            name="ck_bookings_24h_client_sent_claim_clear",
        ),
        CheckConstraint(
            "NOT reminder_24h_master_sent "
            "OR reminder_24h_master_claimed_at IS NULL",
            name="ck_bookings_24h_master_sent_claim_clear",
        ),
        CheckConstraint(
            "NOT reminder_2h_client_sent "
            "OR reminder_2h_client_claimed_at IS NULL",
            name="ck_bookings_2h_client_sent_claim_clear",
        ),
        CheckConstraint(
            "NOT reminder_2h_master_sent "
            "OR reminder_2h_master_claimed_at IS NULL",
            name="ck_bookings_2h_master_sent_claim_clear",
        ),
        Index(
