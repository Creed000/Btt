...
def _job_status(
    ...
    if not enabled_jobs:
        return "⚠️ зарегистрирована, но выключена"
...
def _reminder_schema_status() -> str:
    try:
        ...
        if (
            ...
            return "❌ таблица bookings отсутствует"
        ...
        logger.exception(
            "Не удалось проверить схему reminders"
        )
        return "❌ ошибка проверки"
