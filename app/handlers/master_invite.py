...
def expire_invite_if_needed(
    db,
    invite: MasterSalonInvite,
) -> bool:
    if not invite_is_expired(invite):
        return False
...
async def accept_master_invite(
    ...
    try:
        ...
        if expire_invite_if_needed(
            db,
            invite,
        ):
            raise ValueError(
                "Срок действия приглашения истёк. "
                "Попросите владельца салона отправить новое."
            )
...
async def decline_master_invite(
    ...
    try:
        ...
        if expire_invite_if_needed(
            ...
            raise ValueError(
                "Срок действия приглашения уже истёк."
            )
